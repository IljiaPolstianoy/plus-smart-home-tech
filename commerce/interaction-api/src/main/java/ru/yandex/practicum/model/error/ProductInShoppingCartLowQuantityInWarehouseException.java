...
public class ProductInShoppingCartLowQuantityInWarehouseException extends RuntimeException {
    ...
    // Поля с @JsonProperty сохраняют JSON‑структуру, но не конфликтуют с Throwable

    @JsonProperty("cause")
    private Cause errorCause; // Не getCause()!

    @JsonProperty("stackTrace")
    private List<StackTraceElement> jsonStackTrace; // Не getStackTrace()!
    ...
    private List<Cause> suppressedCauses; // Не getSuppressed()!
